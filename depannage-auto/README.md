...
> **Version 2.0** - Avec gestion multi-employés, filtres avancés et recherche ! 🎉
> 📄 Voir [MISE_A_JOUR_V2.md](MISE_A_JOUR_V2.md) pour les nouveautés
...
### Employés
- **Employé 1** - Login: `employe1`, Password: `employe1` (Hassan Bennani)
- **Employé 2** - Login: `employe2`, Password: `employe2` (Samira Alaoui)
- **Employé 3** - Login: `employe3`, Password: `employe3` (Omar Tazi)
...
- nom_complet (TEXT) -- NOUVEAU en v2.0
